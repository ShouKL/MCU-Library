...
typedef enum {
	...
	AD7799_RATE_39HZ,
	AD7799_RATE_33_2HZ,
	AD7799_RATE_19_6HZ_90DB,
	AD7799_RATE_16_7HZ_80DB,
	AD7799_RATE_16_7HZ_65DB,
	AD7799_RATE_12_5HZ_66DB,
	AD7799_RATE_10HZ_69DB,
	AD7799_RATE_8_33HZ_70DB,
	AD7799_RATE_6_25HZ_72DB,
	AD7799_RATE_4_17HZ_74DB
} AD7799_Rate;
...
public:
  	void Init(void);
	void Reset();
	uint32_t GetRegisterValue(uint8_t regAddress,uint8_t size);
	void SetRegisterValue(uint8_t regAddress,uint32_t regValue, uint8_t size);
	void SetRate(AD7799_Rate rate);
	void SetMode(AD7799_Mode mode);
	uint8_t Ready();
	void SetChannel(AD7799_Channel channel);
	void SetGain(AD7799_Gain gain);
	void SetReference(uint8_t state);
	void SetPolarity(AD7799_Polarity polarity);
	HAL_StatusTypeDef SingleConversion();
	void RawToVolt();
